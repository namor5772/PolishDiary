...
# -*- coding: utf-8 -*-
"""
Polish_handwriting_transcriber_v3
---------------------------------
...
python Polish_handwriting_transcriber_v3.py
"""
...
# Optional: save preprocessed images next to outputs for debugging
...
def _preprocess_pillow(pil_img: Image.Image) -> Image.Image:
    ...
    if UPSCALE_FACTOR and UPSCALE_FACTOR > 1.0:
        w, h = img.size
        img = img.resize((int(w * UPSCALE_FACTOR), int(h * UPSCALE_FACTOR)), Image.Resampling.BICUBIC)
